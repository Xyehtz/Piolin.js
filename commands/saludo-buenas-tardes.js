...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName('saludo-buenas-tardes') // Good evening gretting in English
    .setDescription(
      'Envia un saludo de Buenas tardes, todos los dias a las 12 PM' // Sends a good evening gretting everyday at 12 PM
    ),
